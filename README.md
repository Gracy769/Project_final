...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&duration=3000&pause=800&color=00D9FF&center=true&vCenter=true&multiline=true&width=750&height=90&lines=Sipeed+Maix+K210+%7C+TinyYOLOv2+%7C+0.8+TOPS;Fully+Offline+%E2%80%94+No+Cloud%2C+No+PC%2C+No+Network;Under+%E2%82%B93%2C000+Total+Build+Cost" alt="Typing SVG" />
  </a>
</p>

<p align="center">
  <img alt="Platform" src="https://img.shields.io/badge/Platform-Kendryte%20K210-blue?style=for-the-badge&logo=espressif" />
  <img alt="Cost" src="https://img.shields.io/badge/Cost-%E2%82%B92%2C950-green?style=for-the-badge" />
  <img alt="AI" src="https://img.shields.io/badge/AI-TinyYOLOv2-orange?style=for-the-badge" />
...
**Category:** Manufacturing and Quality Control  
...
- [Existing Solutions](#2-existing-solutions-and-their-limitations)
- [Proposed Solution](#3-proposed-solution)
- [System Architecture](#4-system-architecture)
- [Circuit Connection Diagram](#5-circuit-connection-diagram)
- [Component List](#6-component-list)
- [AI Model Pipeline](#7-ai-model-pipeline)
- [Comparison with Existing Approaches](#8-comparison-with-existing-approaches)
- [Expected Outcomes](#9-expected-outcomes)
- [Project Timeline](#10-project-timeline)
- [Estimated Budget](#11-estimated-budget)
...
| **Commercial AOI Machines** (e.g., Koh Young, Mirtec, Omron) | Industrial automated optical inspection systems with structured lighting and multi-angle cameras | Cost: Rs 15-50 lakhs per unit; requires dedicated floor space; not accessible to MSMEs |
| **Desktop AOI Software** (e.g., VisionBot, Macula) | PC-based software that analyses images from external cameras | Requires a dedicated PC, high-resolution industrial camera, and internet/cloud connectivity |
...
| **Visual Output** | Displays live camera feed with bounding boxes around detected defects on 2.4" colour LCD. |
| **Low Cost** | Total system cost under Rs 3,000, compared to Rs 15-50 lakhs for commercial alternatives. |
...
| S.No. | Component | Specification | Quantity | Estimated Cost (Rs) |
|---|---|---|---|---|
| 1 | Sipeed Maix Bit Development Board | Kendryte K210, Dual-core RISC-V @ 400 MHz, 8 MB SRAM, KPU Neural Network Processor (0.8 TOPS), USB-C | 1 | 1,400 |
| 2 | OV5640 Camera Module | 5 Megapixel, Autofocus, DVP Interface, 24-pin FPC | 1 | 400 |
| 3 | 2.4" TFT LCD Display | ST7789 Driver, 320x240 Resolution, SPI Interface | 1 | 250 |
| 4 | WS2812B LED Ring Light | 12 Addressable RGB LEDs, 5V Operating Voltage | 1 | 150 |
...
| 8 | Tactile Push Button | Momentary, 6x6 mm | 1 | 10 |
...
| 12 | TP4056 Charging Module | Micro-USB, 1A Charge Rate, DW01 Protection | 1 | 30 |
...
|---|---|---|---|
| **Cost** | Rs 0 (operator salary ongoing) | Rs 15-50 Lakhs | **Rs 2,950 (one-time)** |
...
4. Total hardware cost under Rs 3,000, making it accessible to MSME electronics manufacturers.
...
1. PKU PCB Defect Dataset — [github.com/Ixiaohuihuihui/Tiny-Defect-Detection-for-PCB](https://github.com/Ixiaohuihuihui/Tiny-Defect-Detection-for-PCB)
2. DeepPCB Dataset — [github.com/tangsanli5201/DeepPCB](https://github.com/tangsanli5201/DeepPCB)
3. Kendryte K210 Technical Reference Manual — [canaan-creative.com](https://canaan-creative.com/developer)
4. MaixPy Documentation — [wiki.sipeed.com/soft/maixpy/en](https://wiki.sipeed.com/soft/maixpy/en/)
5. NNCase Model Compiler — [github.com/kendryte/nncase](https://github.com/kendryte/nncase)
